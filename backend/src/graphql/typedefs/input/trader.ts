...
export const TraderWhereUniqueInput = inputObjectType({
  name: 'TraderWhereUniqueInput',
  definition(t) {
    t.string('id')
    t.string('name')
  },
...
export const TraderOrderByInput = inputObjectType({
  name: 'TraderOrderByInput',
  definition(t) {
...
export const TraderCreateInput = inputObjectType({
  name: 'TraderCreateInput',
  definition(t) {
...
export const TraderUpdateInput = inputObjectType({
  name: 'TraderUpdateInput',
  definition(t) {
    t.string('name')
